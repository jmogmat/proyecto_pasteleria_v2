                                                        ...
                                                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                                                            <div class="row col-12" >
                                                                <div class="col-6 p-0" style="text-align: left; color: #000000;">
                                                                    <h6 class="my-0"><?php echo $myCart[$i]['nombre']; ?>

                                                                        : <?php echo " x" . $myCart[$i]['cantidad']; ?>
                                                                    </h6>
                                                                </div>
                                                                <div class="col-5 p-0"  style="text-align: right; color: #000000;">
                                                                    <span class="text-muted" style="text-align: right; color: #000000;"><?php echo $myCart[$i]['precio'] ?> €</span>
                                                                </div>
                                                            </div>
                                                            <button style="background-color: white; border: none" onclick="event.preventDefault();deleteItem(<?php echo $myCart[$i]['id'] ?>)"><i class="bi bi-trash3-fill" style="color: red;"></i></button>
                                                        </li>
                                                        <?php
