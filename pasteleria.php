...
<html lang="es">
    ...
    <body class="body_pasteleria">

        <?php
        require_once 'header.php';
        ?>

        <h2 class="title_products" style="margin-top:8%">Productos de pastelería</h2>
        ...
        foreach ($productsPastry as $v) {
            ...
            foreach ($imgProductsPastry as $i) {
                ...
                if ($i['id'] == $v['id']) {
                    ...
                    ?>
                    <div class="shadow shadow flex-item text-center m-2 w-25 h-auto">                                                                                                                      
